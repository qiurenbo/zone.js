...
/**
	 ...
	 * found in the LICENSE file at https://angular.io/license
	 */
let A=!1;if("undefined"!=typeof window)try{const e=Object.defineProperty({},"passive",{get:function(){A=!0}});window.addEventListener("test",e,e),window.removeEventListener("test",e,e)}catch(e){A=!1}const F={useG:!0},H={},G={},q=new RegExp("^"+h+"(\\w+)(true|false)$"),B=d("propagationStopped");function $(e,t,o){const r=o&&o.add||s,a=o&&o.rm||i,c=o&&o.listeners||"eventListeners",p=o&&o.rmAll||"removeAllListeners",f=d(r),g="."+r+":",_="prependListener",m="."+_+":",k=function(e,t,n){if(e.isRemoved)return;const o=e.callback;"object"==typeof o&&o.handleEvent&&(e.callback=(e=>o.handleEvent(e)),e.originalDelegate=o),e.invoke(e,t,[n]);const r=e.options;r&&"object"==typeof r&&r.once&&t[a].call(t,n.type,e.originalDelegate?e.originalDelegate:e.callback,r)},y=function(t){if(!(t=t||e.event))return;const n=this||t.target||e,o=n[H[t.type][u]];if(o)if(1===o.length)k(o[0],n,t);else{const e=o.slice();for(let o=0;o<e.length&&(!t||!0!==t[B]);o++)k(e[o],n,t)}},b=function(t){if(!(t=t||e.event))return;const n=this||t.target||e,o=n[H[t.type][l]];if(o)if(1===o.length)k(o[0],n,t);else{const e=o.slice();for(let o=0;o<e.length&&(!t||!0!==t[B]);o++)k(e[o],n,t)}};function v(t,o){if(!t)return!1;let s=!0;o&&void 0!==o.useG&&(s=o.useG);const i=o&&o.vh;let k=!0;o&&void 0!==o.chkDup&&(k=o.chkDup);let v=!1;o&&void 0!==o.rt&&(v=o.rt);let T=t;for(;T&&!T.hasOwnProperty(r);)T=n(T);if(!T&&t[r]&&(T=t),!T)return!1;if(T[f])return!1;const E=o&&o.eventNameToString,Z={},S=T[f]=T[r],D=T[d(a)]=T[a],P=T[d(c)]=T[c],z=T[d(p)]=T[p];let O;function C(e){A||"boolean"==typeof Z.options||null==Z.options||(e.options=!!Z.options.capture,Z.options=e.options)}o&&o.prepend&&(O=T[d(o.prepend)]=T[o.prepend]);const j=s?function(e){if(!Z.isExisting)return C(e),S.call(Z.target,Z.eventName,Z.capture?b:y,Z.options)}:function(e){return C(e),S.call(Z.target,Z.eventName,e.invoke,Z.options)},I=s?function(e){if(!e.isRemoved){const t=H[e.eventName];let n;t&&(n=t[e.capture?l:u]);const o=n&&e.target[n];if(o)for(let t=0;t<o.length;t++)if(o[t]===e){o.splice(t,1),e.isRemoved=!0,0===o.length&&(e.allRemoved=!0,e.target[n]=null);break}}if(e.allRemoved)return D.call(e.target,e.eventName,e.capture?b:y,e.options)}:function(e){return D.call(e.target,e.eventName,e.invoke,e.options)},R=o&&o.diff?o.diff:function(e,t){const n=typeof t;return"function"===n&&e.callback===t||"object"===n&&e.originalDelegate===t},M=Zone[d("BLACK_LISTED_EVENTS")],L=function(t,n,o,r,a=!1,c=!1){return function(){const p=this||e,f=arguments[0];let d=arguments[1];if(!d)return t.apply(this,arguments);if(w&&"uncaughtException"===f)return t.apply(this,arguments);let g=!1;if("function"!=typeof d){if(!d.handleEvent)return t.apply(this,arguments);g=!0}if(i&&!i(t,d,p,arguments))return;const _=arguments[2];if(M)for(let e=0;e<M.length;e++)if(f===M[e])return t.apply(this,arguments);let m,y=!1;void 0===_?m=!1:!0===_?m=!0:!1===_?m=!1:(m=!!_&&!!_.capture,y=!!_&&!!_.once);const b=Zone.current,v=H[f];let T;if(v)T=v[m?l:u];else{const e=(E?E(f):f)+u,t=(E?E(f):f)+l,n=h+e,o=h+t;H[f]={},H[f][u]=n,H[f][l]=o,T=m?o:n}let S,D=p[T],P=!1;if(D){if(P=!0,k)for(let e=0;e<D.length;e++)if(R(D[e],d))return}else D=p[T]=[];const z=p.constructor.name,O=G[z];O&&(S=O[f]),S||(S=z+n+(E?E(f):f)),Z.options=_,y&&(Z.options.once=!1),Z.target=p,Z.capture=m,Z.eventName=f,Z.isExisting=P;const C=s?F:void 0;C&&(C.taskData=Z);const j=b.scheduleEventTask(S,d,C,o,r);return Z.target=null,C&&(C.taskData=null),y&&(_.once=!0),(A||"boolean"!=typeof j.options)&&(j.options=_),j.target=p,j.capture=m,j.eventName=f,g&&(j.originalDelegate=d),c?D.unshift(j):D.push(j),a?p:void 0}};return T[r]=L(S,g,j,I,v),O&&(T[_]=L(O,m,function(e){return O.call(Z.target,Z.eventName,e.invoke,Z.options)},I,v,!0)),T[a]=function(){const t=this||e,n=arguments[0],o=arguments[2];let r;r=void 0!==o&&(!0===o||!1!==o&&!!o&&!!o.capture);const s=arguments[1];if(!s)return D.apply(this,arguments);if(i&&!i(D,s,t,arguments))return;const a=H[n];let c;a&&(c=a[r?l:u]);const h=c&&t[c];if(h)for(let e=0;e<h.length;e++){const n=h[e];if(R(n,s))return h.splice(e,1),n.isRemoved=!0,0===h.length&&(n.allRemoved=!0,t[c]=null),n.zone.cancelTask(n),v?t:void 0}return D.apply(this,arguments)},T[c]=function(){const t=arguments[0],n=[],o=U(this||e,E?E(t):t);for(let e=0;e<o.length;e++){const t=o[e];n.push(t.originalDelegate?t.originalDelegate:t.callback)}return n},T[p]=function(){const t=this||e,n=arguments[0];if(n){const e=H[n];if(e){const o=t[e[u]],r=t[e[l]];if(o){const e=o.slice();for(let t=0;t<e.length;t++){const o=e[t];this[a].call(this,n,o.originalDelegate?o.originalDelegate:o.callback,o.options)}}if(r){const e=r.slice();for(let t=0;t<e.length;t++){const o=e[t];this[a].call(this,n,o.originalDelegate?o.originalDelegate:o.callback,o.options)}}}}else{const e=Object.keys(t);for(let t=0;t<e.length;t++){const n=q.exec(e[t]);let o=n&&n[1];o&&"removeListener"!==o&&this[p].call(this,o)}this[p].call(this,"removeListener")}if(v)return this},x(T[r],S),x(T[a],D),z&&x(T[p],z),P&&x(T[c],P),!0}let T=[];for(let e=0;e<t.length;e++)T[e]=v(t[e],o);return T}function U(e,t){const n=[];for(let o in e){const r=q.exec(o);let s=r&&r[1];if(s&&(!t||s===t)){const t=e[o];if(t)for(let e=0;e<t.length;e++)n.push(t[e])}}return n}function W(e,t){const n=e.Event;n&&n.prototype&&t.patchMethod(n.prototype,"stopImmediatePropagation",e=>(function(t,n){t[B]=!0,e&&e.apply(t,n)}))}
/**
	 * @license
	 * Copyright Google Inc. All Rights Reserved.
	 *
