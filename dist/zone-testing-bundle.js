...
function patchEventTarget(_global, apis, patchOptions) {
    ...
    Object.keys(pointerEventsMap).forEach(function (msEventName) {
        var eventName = pointerEventsMap[msEventName];
        zoneSymbolEventNames$1[eventName] = {};
        zoneSymbolEventNames$1[eventName][FALSE_STR] = ZONE_SYMBOL_PREFIX + eventName + FALSE_STR;
        zoneSymbolEventNames$1[eventName][TRUE_STR] = ZONE_SYMBOL_PREFIX + eventName + TRUE_STR;
        zoneSymbolEventNames$1[msEventName] = {};
        zoneSymbolEventNames$1[msEventName][FALSE_STR] = ZONE_SYMBOL_PREFIX + msEventName + FALSE_STR;
        zoneSymbolEventNames$1[msEventName][TRUE_STR] = ZONE_SYMBOL_PREFIX + msEventName + TRUE_STR;
    });
    ...
    var globalZoneAwareCallback = function (event) {
        ...
        if (isIEOrEdge) {
            var pointerMappedEvent = pointerEventsMap[event.type];
            var msTasks = pointerMappedEvent && target[zoneSymbolEventNames$1[pointerMappedEvent]][FALSE_STR];
            if (msTasks) {
    ...
    function patchEventTargetMethods(obj, patchOptions) {
        ...
        var makeAddListener = function (nativeListener, addSource, customScheduleFn, customCancelFn, returnTarget, prepend) {
            ...
            return function () {
                ...
                if (isIEOrEdge) {
                    var msEventName = pointerEventsMap[eventName];
                ...
                if (isIEOrEdge && !existingTasks) {
                    ...
                    if (msEventName) {
                        existingTasks =
                            target[zoneSymbolEventNames$1[msEventName][capture ? TRUE_STR : FALSE_STR]];
                    }
                }
                if (existingTasks) {
