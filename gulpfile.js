...
function tsc(config, cb) {
  spawn(
    path.normalize(platformScriptPath("./node_modules/.bin/tsc")),
    ["-p", config],
    {
      stdio: "inherit"
    }
...
gulp.task("build/zone.js", ["compile-esm"], function(cb) {
  return generateScript(
    "./lib/browser/rollup-legacy-main.ts",
    "zone.js",
    false,
    cb
  );
...
gulp.task("build/zone-testing-bundle.js", ["compile-esm"], function(cb) {
  return generateScript(
    "./lib/browser/rollup-legacy-test-main.ts",
...
gulp.task("build/zone-evergreen-testing-bundle.js", ["compile-esm"], function(
  cb
) {
  return generateScript(
    "./lib/browser/rollup-test-main.ts",
...
gulp.task("build/webapis-rtc-peer-connection.js", ["compile-esm"], function(
  cb
) {
  return generateScript(
    "./lib/browser/webapis-rtc-peer-connection.ts",
...
gulp.task("build/webapis-rtc-peer-connection.min.js", ["compile-esm"], function(
  cb
) {
  return generateScript(
    "./lib/browser/webapis-rtc-peer-connection.ts",
...
gulp.task("build/zone-patch-promise-testing.min.js", ["compile-esm"], function(
  cb
) {
  return generateScript(
    "./lib/testing/promise-testing.ts",
...
gulp.task("build/zone-patch-resize-observer.min.js", ["compile-esm"], function(
  cb
) {
  return generateScript(
    "./lib/browser/webapis-resize-observer.ts",
...
gulp.task("build/task-tracking.js", ["compile-esm"], function(cb) {
  return generateScript(
    "./lib/zone-spec/task-tracking.ts",
    "task-tracking.js",
    false,
    cb
  );
...
const srcsToFmt = ["lib/**/*.ts", "test/**/*.ts"];
